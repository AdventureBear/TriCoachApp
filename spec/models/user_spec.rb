...
describe "A user" do
  ...
  it "requires a password confirmation when a password is present" do
    user = User.new(password: "secretwords", password_confirmation: "")
  ...
  it "requires the password to match the password confirmation" do
    user = User.new(password: "secretwords", password_confirmation: "nomatch")
  ...
  it "requires a password and matching password confirmation when creating" do
    user = User.create!(user_attributes(password: "secretwords", password_confirmation: "secretwords"))
